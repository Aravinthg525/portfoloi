      ...
      <div className="flex-1">
        <div className="font-bold dark:text-white text-4xl">
          ...
          <p className="text-sm font-semibold text-black bg-clip-text mt-4">
            Certified Web Developer with a strong foundation <br /> in
            Fornt end development. <br /> I have maintained 10 repositories
          ...
          <div className="flex mt-5 gap-8">
            {/* GitHub */}
            <a
              href="https://github.com/Aravinthg525"
              target="_blank"
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/in/surendar007ak/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
            ...
            {/* GeeksforGeeks */}
            <a
              href="https://www.geeksforgeeks.org/user/aravindarhyl6/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
            ...
            {/* LeetCode */}
            <a
              href="https://leetcode.com/u/Surendar-G/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
