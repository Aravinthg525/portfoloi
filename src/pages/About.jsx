      ...
      <div className="flex flex-col md:flex-row max-w-6xl mx-auto p-6 shadow-lg rounded-lg bg-white dark:bg-gray-800">
        ...
        <div className="flex-1 p-6 md:p-10 flex flex-col justify-center font-serif">
          ...
          <p className="mt-4 text-lg leading-relaxed text-gray-800 dark:text-gray-300 flex items-center">
            ...
            Hi, I’m Surendar from Bommidi, a certified web developer from infosys springboard. I hold a Bachelor degree in Computer Science Engineering (BE CSE).
          </p>
          
          <p className="mt-4 text-lg leading-relaxed text-gray-800 dark:text-gray-300 flex items-center">
            <i className="fas fa-code text-blue-500 mr-2"></i>
            My coding journey began in 2023, guided by Pranav, an IT professional who provided me with valuable knowledge and project opportunities.
          </p>
          
          <p className="mt-4 text-lg leading-relaxed text-gray-800 dark:text-gray-300 flex items-center">
            <i className="fas fa-users text-blue-500 mr-2"></i>
            During a 1-month internship in TechVolt Software Pvt Ltd.
          </p>
          ...
          <p className="mt-4 text-lg leading-relaxed text-gray-800 dark:text-gray-300 flex items-center">
            ...
            I'm currently learning  Artificial Intelligence and Data Science to enhance my skills.
          </p>
        </div>
      </div>
    </div>
