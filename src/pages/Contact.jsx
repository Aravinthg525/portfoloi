    ...
    <div className="flex p-6 mt-10 max-w-4xl mx-auto flex-col md:flex-row md:items-start mb-80">
      ...
      <div className="flex-1 bg-white shadow-lg rounded-lg p-6 mb-6 md:mb-0 md:mr-6 dark:bg-gray-800">
        ...
        <p className="text-gray-900 dark:text-gray-300">
          <strong>Name:</strong> Surendar G
        </p>
        <p className="text-gray-900 dark:text-gray-300 mt-2">
          <strong>Email:</strong> aravindaravindhak@gmail.com
        </p>
        <p className="text-gray-900 dark:text-gray-300 mt-2">
          <strong>Mobile Number:</strong> 9514714675
        </p>
        <p className="text-gray-900 dark:text-gray-300 mt-4">
          <strong>GitHub:</strong> <a href="https://github.com/Aravinthg525" className="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">🌐 github.com/Aravinthg525</a>
        </p>
        <p className="text-gray-900 dark:text-gray-300 mt-2">
          <strong>LinkedIn:</strong> <a href="https://www.linkedin.com/in/surendar007ak/" className="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">🔗 linkedin.com/in/surendar007ak/</a>
        </p>
        <p className="text-gray-900 dark:text-gray-300 mt-2">
          <strong>WhatsApp:</strong> <a href="https://wa.me/9514714675" className="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">📱 +91 9514714675</a>
        </p>
      </div>
