...
const Header = () => {
    ...
    return (
        <Navbar fluid rounded   >
            <Navbar.Brand >
                <span className="self-center whitespace-nowrap tet-with text-xl font-semibold dark:text-white pacifico-regular bg-gradient-to-r from-teal-400 to-blue-500 mr-1 p-2 rounded-2xl">Surendar</span>
